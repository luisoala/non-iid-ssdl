...
def run_tests_minkowski_MNIST_medium_complete_no_half(p = 1, ood_perc = 50):
    """
    :param distance: distance_str
    :return:
    """
    path_labelled = "/media/Data/user/Datasets/MNIST_medium_complete/batches_labeled_in_dist/batch_"
    path_base_unlabelled = "/media/Data/user/Datasets/MNIST_medium_complete"
    ...
    #SVHN
    print("Calculating p" + str(p) + " distance for SVHN dataset")
    dataset_distance_tester(
        path_bunch1=path_labelled,
        path_bunch2= path_base_unlabelled + "/batches_unlabeled_SVHN/batch_", ood_perc=ood_perc,
        num_unlabeled=3000, name_ood_dataset="SVHN__p_" + str(p), num_batches = 10, p = p)
...
def run_tests_pdf_MNIST_medium_complete_no_half(distance_str = "js", ood_perc = 50):
    """
    :param distance: distance_str
    :return:
    """
...
def run_MNIST_medium_complete_tests_pdf():
    run_tests_pdf_MNIST_medium_complete_no_half(distance_str="js", ood_perc=50)
    run_tests_pdf_MNIST_medium_complete_no_half(distance_str="js", ood_perc=100)
    run_tests_pdf_MNIST_medium_complete_no_half(distance_str="cosine", ood_perc=50)
    run_tests_pdf_MNIST_medium_complete_no_half(distance_str="cosine", ood_perc=100)


def run_MNIST_medium_complete_tests_p():
    run_tests_minkowski_MNIST_medium_complete_no_half(p = 1, ood_perc=50)
    run_tests_minkowski_MNIST_medium_complete_no_half(p = 1, ood_perc=100)
    run_tests_minkowski_MNIST_medium_complete_no_half(p = 2, ood_perc=50)
    run_tests_minkowski_MNIST_medium_complete_no_half(p = 2, ood_perc=100)

run_MNIST_medium_complete_tests_pdf()

...
def run_tests_minkowski_cifar10_no_half(p = 1, ood_perc = 50):
    """
    :param distance: distance_str
    :return:
    """
    path_labelled = "/media/Data/user/Datasets/CIFAR10/batches_labeled_in_dist/batch_"
    path_base_unlabelled = "/media/Data/user/Datasets/CIFAR10"
...
def run_tests_pdf_cifar10_no_half(distance_str = "js", ood_perc = 50):
    """
    :param distance: distance_str
    :return:
    """
...
def run_cifar10_tests_pdf():
    run_tests_pdf_cifar10_no_half(distance_str="js", ood_perc=50)
    run_tests_pdf_cifar10_no_half(distance_str="js", ood_perc=100)
    run_tests_pdf_cifar10_no_half(distance_str="cosine", ood_perc=50)
    run_tests_pdf_cifar10_no_half(distance_str="cosine", ood_perc=100)

def run_cifar10_tests_p():
    run_tests_minkowski_cifar10_no_half(p = 1, ood_perc=50)
    run_tests_minkowski_cifar10_no_half(p = 1, ood_perc=100)
    run_tests_minkowski_cifar10_no_half(p = 2, ood_perc=50)
    run_tests_minkowski_cifar10_no_half(p = 2, ood_perc=100)


run_cifar10_tests_pdf()

...
def run_tests_pdf_cifar10_half(distance_str = "js", ood_perc = 100):
    """
    :param distance: distance_str
    :return:
    """
    path_labelled =  "/media/Data/user/Datasets/CIFAR10/batches_labeled_in_dist_60"
    path_base_unlabelled = "/media/Data/user/Datasets/CIFAR10/batches_unlabeled_HALF_60"
...
def run_tests_minkowski_cifar10_half(p = 1, ood_perc = 100):
    """
    :param distance: distance_str
    :return:
    """
...
def run_cifar10_tests_p(ood_perc = 50):
    run_tests_minkowski_cifar10_half(p=1, ood_perc = ood_perc)
    run_tests_minkowski_cifar10_half(p=2, ood_perc = ood_perc)

def run_cifar10_tests_pdf(ood_perc = 50):
    run_tests_pdf_cifar10_half(distance_str="js", ood_perc = ood_perc)
    run_tests_pdf_cifar10_half(distance_str="cosine", ood_perc = ood_perc)




run_cifar10_tests_p(ood_perc = 50)
run_cifar10_tests_pdf(ood_perc = 50)
